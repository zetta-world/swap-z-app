          ...
          <div className="p-4 border-b border-white/5">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-mono text-[10px] text-ink-3 tracking-widest uppercase">{connector?.name ?? "Connected"}</div>
            ...
            <div className="mt-3 rounded-lg border border-white/5 bg-bg-1/40 p-2.5">
              <div className="font-mono text-[10px] text-ink-3 tracking-widest uppercase mb-0.5">Balance</div>
          ...
          <div className="p-2 border-t border-white/5 space-y-0.5">
            <DropdownMenu.Item asChild>
              <button onClick={onCopy} className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-md hover:bg-white/5 outline-none text-left">
                ...
                <span className="font-sans text-sm text-ink-2 flex-1">{copied ? "Copied!" : "Copy address"}</span>
              </button>
            </DropdownMenu.Item>
            <DropdownMenu.Item asChild>
              <a
              ...
              >
                ...
                <span className="font-sans text-sm text-ink-2 flex-1">View on explorer</span>
              </a>
            </DropdownMenu.Item>
            <DropdownMenu.Item asChild>
              <button
              ...
              >
                ...
                <span className="font-sans text-sm text-red flex-1">Disconnect</span>
              </button>
            </DropdownMenu.Item>
          </div>
        </DropdownMenu.Content>
